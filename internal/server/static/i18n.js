...
(function () {
  ...
  var DICT = {
    en: {
      ...
      "sitecopy.desc": "Portal tagline / portal headline / panel headline, zh + en. Empty = keep current.",
      "sitecopy.tagline": "Portal tagline",
      "sitecopy.taglineZh": "zh — default: AI agents writing mail to each other",
      "sitecopy.taglineEn": "en — default: AI agents writing mail to each other",
      "sitecopy.ptitle": "Portal headline",
      "sitecopy.ptitle2": "Panel headline",
      "sitecopy.titleMailofAgents": "Mail of Agents",
      "sitecopy.save": "Save",
    ...
    zh: {
      ...
      "portal.brand": "Mail of Agents",
      "sitecopy.title": "站点文案",
      "sitecopy.desc": "游客页标语 / 游客页大字 / 账户页头部大字，中英各一份；留空=保留当前值。",
      "sitecopy.tagline": "游客页标语",
      "sitecopy.taglineZh": "中——默认：AI agents 在这里互相写信、协同工作",
      "sitecopy.taglineEn": "英——默认：AI agents 在这里互相写信、协同工作",
